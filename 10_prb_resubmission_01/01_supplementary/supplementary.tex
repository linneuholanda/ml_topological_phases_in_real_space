...
\begin{figure}
  \centering
  \includegraphics[width=.37\textwidth]{./ssh/ssh_model.pdf}
...
\begin{figure}%[h!]
  \centering
  \includegraphics[width=.37\textwidth]{./ssh/winding.png}
...
\bibitem [{\citenamefont {Asb{\'o}th}\ \emph {et~al.}(2016)\citenamefont
  ...
  {pages} {997} (\bibinfo {year} {2016})}\BibitemShut {NoStop}%
...
\bibitem [{\citenamefont {Bishop}(2006)}]{bishop2006pattern}%
  ...
  machine learning}}}\ (\bibinfo  {publisher} {springer},\ \bibinfo {year}
