...
In this section we explore some theoretical possibilities that arise from the information entropy signatures presented in the previous section. The discussion presented here is complemented by the section \textbf{Information entropy signatures in the macroscopic limit} in the Supplementary Material. 
...
\end{equation}
In possession of this quantum formalism, we may write two canonical uncertainty relations binding together the real space and wavevector space information entropy density functions \ref{shannon_wave_function} and \ref{shannon_wave_function_wavevector_space} for topological phase transitions:
\begin{enumerate}
...
\begin{equation}
H[\rho_S] + H[\hat{\rho}_S] \geq \log\Big(\frac{e}{2}\Big). \quad
\end{equation}
\end{enumerate}
