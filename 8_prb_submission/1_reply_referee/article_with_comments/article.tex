...
\textcolor{blue}{As of yet model explainability is one of the topics at the forefront of machine learning research that has been little explored by the physics community working at the interface between the two disciplines. By tying together contemporary concepts in physics (topological phase transitions and information theory) to a topic at the edge of machine learning research (model explainability) we hope to append the latter to the growing list of machine learning tools at physcists' disposal.  }\citequote{pipeline_not_work}
\begin{figure}
\centering
