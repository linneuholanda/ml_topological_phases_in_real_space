...
\begin{figure}
\centering
\subfigure[]{\label{figexp1_exp:a}\includegraphics[width=.32\textwidth]{./ssh1/real_space_all_sites/scatter_train_val_test_experiment_0-1.png}}\quad
\subfigure[]{\label{figexp1_exp:b}\includegraphics[width=.32\textwidth]{./ssh1/real_space_all_sites/scatter_winding_train_experiment_0-1.png}}
\subfigure[]{\label{figexp1_exp:c}\includegraphics[width=.32\textwidth]{./ssh1/real_space_all_sites/pcolormesh_prediction_grid_experiment_0-1.png}}
...
\begin{figure}
\centering
\subfigure[]{\label{figexp2_exp:a}\includegraphics[width=.32\textwidth]{./ssh2/real_space_all_sites/scatter_train_val_test_experiment_0-2.png}}\quad
\subfigure[]{\label{figexp2_exp:b}\includegraphics[width=.32\textwidth]{./ssh2/real_space_all_sites/scatter_winding_train_experiment_0-2.png}}
\subfigure[]{\label{figexp2_exp:c}\includegraphics[width=.32\textwidth]{./ssh2/real_space_all_sites/pcolormesh_prediction_grid_experiment_0-2.png}}
...
\begin{figure}
\centering
\subfigure[]{\label{ssh1_heatmap_0}\includegraphics[width=.32\textwidth]{./ssh1/real_space_all_sites/imshow_winding_grid_winding_0_sim-1.png}}
\subfigure[]{\label{ssh1_heatmap_1}\includegraphics[width=.32\textwidth]{./ssh1/real_space_all_sites/imshow_winding_grid_winding_1_sim-1.png}}
\subfigure[]{\label{ssh1_heatmap}\includegraphics[width=.32\textwidth]{./ssh1/real_space_all_sites/merge_imshow_winding_grids_second_sim-1.png}}
...
\begin{figure}
\centering
\subfigure[]{\label{ssh2_heatmap_-1}\includegraphics[width=.32\textwidth]{./ssh2/real_space_all_sites/imshow_winding_grid_winding_-1_sim-2.png}}
\subfigure[]{\label{ssh2_heatmap_0}\includegraphics[width=.32\textwidth]{./ssh2/real_space_all_sites/imshow_winding_grid_winding_0_sim-2.png}}
\subfigure[]{\label{ssh2_heatmap_1}\includegraphics[width=.32\textwidth]{./ssh2/real_space_all_sites/imshow_winding_grid_winding_1_sim-2.png}}
\subfigure[]{\label{ssh2_heatmap_2}\includegraphics[width=.32\textwidth]{./ssh2/real_space_all_sites/imshow_winding_grid_winding_2_sim-2.png}}
\subfigure[]{\label{ssh2_heatmap}\includegraphics[width=.32\textwidth]{./ssh2/real_space_all_sites/merge_imshow_winding_grids_sim-2.png}}
...
\begin{figure}
\centering
\subfigure[]{\label{feature_importances_ssh1}\includegraphics[width=0.49\textwidth]{./ssh1/real_space_all_sites/plot_feature_importances-1.png}}\quad
\subfigure[]{\label{feature_importances_ssh2}\includegraphics[width=0.49\textwidth]{./ssh2/real_space_all_sites/plot_feature_importances-2.png}}\quad
